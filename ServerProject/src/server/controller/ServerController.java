...
public class ServerController extends AbstractServer {
	...
	/**
	 * Called when a client connects to the server. Logs the connection and updates
	 * the GUI table via ServerViewController.
	 */
	@Override
	...
	/**
	 * Called when a client disconnects from the server. Logs the disconnection and
	 * updates the GUI table via ServerViewController.
	 */
	@Override
	...
	/**
	 * Called when an exception occurs on the client's connection. Ensures the
